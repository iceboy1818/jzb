...
public class RpcProcessorExample {
	...
	public static void main(String[] args) throws Exception {   
		...
		processor.setModule(new InterfaceExampleImpl()); //By default interface full name, empty are used as module name
		//processor.addModule(module, services); //You can define module name, it is optional
		processor.setModule(new BaseExtImpl());
