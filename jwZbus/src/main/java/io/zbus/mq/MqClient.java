...
public class MqClient extends MessageClient{         
	...
	public MqClient(String serverAddress, final EventLoop driver){
    ...
    //message.status stands for consume status, message should recover from origin_url and origin_status
