...
public class RpcProcessor implements MessageHandler{
	...
	public void setModule(Object... services){
		for(Object obj : services){
			for(Class<?> intf : getAllInterfaces(obj.getClass())){
				setModule(intf.getSimpleName(), obj);
				setModule(intf.getName(), obj);
			}
			setModule("", obj);
			setModule(obj.getClass().getSimpleName(), obj);
			setModule(obj.getClass().getName(), obj);
		} 
	}
	
	public void setModule(String module, Object... services){
